...
static const ParameterInfo parameter_lookup[] = {
    ...
    { 11, 1, 0, 100 }, // chord alternate percent range lower
    { 201, 1, 0, 100 }, // chord alternate percent range upper
    { 12, 1, 21, 219 }, // harp alternate control
    { 13, 1, 0, 100 }, // harp alternate percent range lower
    { 202, 1, 0, 100 }, // harp alternate percent range upper
    { 14, 1, 21, 219 }, // mod main control
    { 15, 1, 0, 100 }, // mod main percent range lower
    { 200, 1, 0, 100 }, // mod main percent range upper
    { 16, 1, 21, 219 }, // mod alternate control
    { 17, 1, 0, 100 }, // mod alternate percent range lower
    { 203, 1, 0, 100 }, // mod alternate percent range upper
